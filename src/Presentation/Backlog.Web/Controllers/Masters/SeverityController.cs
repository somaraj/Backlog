    ...
    public class SeverityController : BaseController
    {
        ...
        public async Task<IActionResult> Create(SeverityModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _employeeActivityService.InsertAsync("Severity", string.Format(await _localizationService.GetResourceAsync("Log.RecordCreated"), entity.Name), entity);
        ...
        public async Task<IActionResult> Edit(SeverityModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _employeeActivityService.InsertAsync("Severity", string.Format(await _localizationService.GetResourceAsync("Log.RecordUpdated"), entity.Name), entity);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            await _employeeActivityService.InsertAsync("Severity", string.Format(await _localizationService.GetResourceAsync("Log.RecordDeleted"), entity.Name), entity);
        ...
        public async Task<IActionResult> DataRead(DataSourceRequest request)
        {
            ...
            var data = await _severityService.GetPagedListAsync(search, request.Start, request.Length,
