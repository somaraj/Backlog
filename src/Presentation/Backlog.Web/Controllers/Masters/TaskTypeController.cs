    ...
    public class TaskTypeController : BaseController
    {
        ...
        public async Task<IActionResult> Create(TaskTypeModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _employeeActivityService.InsertAsync("TaskType", string.Format(await _localizationService.GetResourceAsync("Log.RecordCreated"), entity.Name), entity);
        ...
        public async Task<IActionResult> Edit(TaskTypeModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _employeeActivityService.InsertAsync("TaskType", string.Format(await _localizationService.GetResourceAsync("Log.RecordUpdated"), entity.Name), entity);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            await _employeeActivityService.InsertAsync("TaskType", string.Format(await _localizationService.GetResourceAsync("Log.RecordDeleted"), entity.Name), entity);
        ...
        public async Task<IActionResult> DataRead(DataSourceRequest request)
        {
            ...
            var data = await _taskTypeService.GetPagedListAsync(search, request.Start, request.Length,
